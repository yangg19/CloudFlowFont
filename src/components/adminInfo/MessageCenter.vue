        ...
        <div>
          <div style="font-size: 15px">
            ...
            <div style="margin-top: 20px">
              ...
              <el-tag v-for="(r, index) in admin.roles" :key="index" type="success" style="margin-left: 7px">{{ r.nameZh }}</el-tag>
            </div>
          </div>
    ...
    >
      <div>
        <table>
          ...
          <tr>
            <td>电话号码：</td>
            <td><el-input v-model="adminDisplay.telephone" /></td>
          </tr>
          <tr>
            <td>手机号码：</td>
            <td><el-input v-model="adminDisplay.phone" /></td>
          </tr>
          <tr>
            <td>用户地址：</td>
            <td><el-input v-model="adminDisplay.address" /></td>
          </tr>
        </table>
      </div>
